...
#define MPU_REG_SELF_TEST_X_GYRO    0x00 // Dec 0,   R/W,  xg_st_data [7:0]
#define MPU_REG_SELF_TEST_Y_GYRO    0x01 // Dec 1,   R/W,  yg_st_data [7:0]
#define MPU_REG_SELF_TEST_Z_GYRO    0x02 // Dec 2,   R/W,  zg_st_data [7:0]
